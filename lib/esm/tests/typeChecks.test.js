import { isStringArray, isStringArrayString, canOnlyBeString, jsonSchema, isBooleanTrueString, isBooleanFalseString, isBooleanNumber, canOnlyBeBoolean } from '../typeChecks';
/**
 * Boolean
 */
