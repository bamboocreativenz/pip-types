...
import { 
  ...
  isNumberArrayString,
  isStringArrayString,
  isObjectArrayString} from './typeChecks';
import { 
  coerceBoolean,
  coerceString,
  coerceNumber,
  ...
  coerceStringArray, 
  coerceNumberArray,
  coerceObjectArray} from './typeCoercions';
...
export const zToObjectArray = z.any()
  ...
  .transform(
    z.array(z.object({}).nonstrict()),
    (data) => coerceObjectArray(data)
)
